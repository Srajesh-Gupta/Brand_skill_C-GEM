...
Both skins share: pure white ground, brushmark C, leaf green primary, Indian numerals (tabular), triplet rhythm.
...
.eyebrow     Mono 11px caps, 0.12em tracking, leaf-600. Section labels.
...
.brushmark-bg  7% opacity brushmark backdrop on section.
```
